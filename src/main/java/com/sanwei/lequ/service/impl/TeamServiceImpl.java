...
import com.sanwei.lequ.model.enums.TeamStatusEnum;
...
import com.sanwei.lequ.model.vo.UserVO;
import com.sanwei.lequ.service.TeamService;
import com.sanwei.lequ.mapper.TeamMapper;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public long addTeam(Team team, User loginUser) {
        ...
        if (StringUtils.isBlank(teamName) || teamName.length() > 20) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "队伍标题不满足要求");
        }
        //  c. 描述 <= 512
    ...
    public List<TeamUserVo> listTeams(TeamQuery teamQuery, boolean isAdmin) {
        ...
        if (teamQuery != null) {
            ...
            if (statusEnum == null) {
                ...
                queryWrapper.eq("status", statusEnum.getValue()).or()
